...
class CloudAnalyzer:
    def __init__(self):
        self.endPoint = 'https://2021csc080-prediction.cognitiveservices.azure.com/customvision/v3.0/Prediction/54f1872d-9850-4c05-8f23-fcb2b5b6bf78/detect/iterations/Iteration3/image'
